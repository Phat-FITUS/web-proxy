...
require (
	github.com/Phat-FITUS/web-proxy/HTTP v0.0.0-00010101000000-000000000000 // indirect
	github.com/Phat-FITUS/web-proxy/Proxy v0.0.0-00010101000000-000000000000 // indirect
